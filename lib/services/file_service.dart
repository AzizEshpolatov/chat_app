...
class FileManagerService {
  ...
  static Future<MessageStatusModel> checkFile(
      MessageModel fileDataModel) async {
    MessageStatusModel fileStatusModel = MessageStatusModel(
      isExist: false,
      newFileLocation: "",
    );
    ...
    List<String> pattern = fileDataModel.messageText.split(".");
    if (pattern.length > 1) {
      savedLocation =
          "${directory != null ? directory!.path : "/storage/emulated/0/Download"}/${fileDataModel.messageText}.${pattern.last}";
    }
